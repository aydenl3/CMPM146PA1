...
def boxesToEdgePoint(point, box): #Returns the closest corner of a box to a given point
    p1 = (box[0],box[2])
    p2 = (box[1],box[2])
    p3 = (box[0],box[3])
    p4 = (box[1],box[3])
